...
void f_scan_edit(void)
{
	...
	while (actual != NULL)
	{
		...
		} else
		{
			...
			/* Zeiger auf Magic (muž MOD_MAGIC_EDIT sein!) */
...
void f_scan_import(void)
{
	...
	while (actual != NULL)
	{
		...
		} else
		{
			...
			/* Zeiger auf Magic (muž MOD_MAGIC_IMPORT sein!) */
...
void f_scan_export(void)
{
	...
	while (actual != NULL)
	{
		...
		} else
		{
			...
			/* Zeiger auf Magic (muž MOD_MAGIC_EXPORT sein!) */
...
void f_scan_dither(void)
{
	...
	while (actual != NULL)
	{
		...
		} else
		{
			...
			/* Zeiger auf Magic (muž MOD_MAGIC_DITHER sein!) */
