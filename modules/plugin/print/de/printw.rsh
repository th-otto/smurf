/*
 * GEM resource C output of printw
 *
...
static char printw_string_0[] = "Ben\224tigtes Programm WDIALOG ist nicht installiert.";
static char printw_string_1[] = "";
static char printw_string_2[] = "";
static char printw_string_3[] = "Kein Bild geladen!";
static char printw_string_4[] = "";
static char printw_string_5[] = "";
static char printw_string_6[] = "Smurf kann den Drucker nicht \224ffnen!";
static char printw_string_7[] = "";
static char printw_string_8[] = "";
static char printw_string_9[] = "Es steht nicht genug Speicher zum Drucken zur Verf\201gung!";
static char printw_string_10[] = "";
static char printw_string_11[] = "";
static char printw_string_12[] = "Nicht genug Speicher f\201r die Aufbereitung der Bilddaten.";
static char printw_string_13[] = "";
static char printw_string_14[] = "";


TEDINFO rs_tedinfo[NUM_TI] = {
	{ printw_string_0, printw_string_1, printw_string_2, IBM, 6, TE_LEFT, 0x1180, 0x0, -1, 51,1 }, /* NO_WDIALOG */
	{ printw_string_3, printw_string_4, printw_string_5, IBM, 6, TE_LEFT, 0x1180, 0x0, -1, 19,1 }, /* NO_PIC */
	{ printw_string_6, printw_string_7, printw_string_8, IBM, 6, TE_LEFT, 0x1180, 0x0, -1, 37,1 }, /* NO_OPEN */
	{ printw_string_9, printw_string_10, printw_string_11, IBM, 6, TE_LEFT, 0x1180, 0x0, -1, 57,1 }, /* NO_PRT_MEM */
	{ printw_string_12, printw_string_13, printw_string_14, IBM, 6, TE_LEFT, 0x1180, 0x0, -1, 57,1 } /* NO_PREP_MEM */
};
...
/* ALERT_STRINGS */
	...
	{ 2, -1, -1, G_TEXT, OF_NONE, OS_NORMAL, C_UNION(&rs_tedinfo[0]), 1,2048, 50,1 }, /* NO_WDIALOG */
	{ 3, -1, -1, G_TEXT, OF_NONE, OS_NORMAL, C_UNION(&rs_tedinfo[1]), 1,2, 18,1 }, /* NO_PIC */
	{ 4, -1, -1, G_TEXT, OF_NONE, OS_NORMAL, C_UNION(&rs_tedinfo[2]), 1,2051, 36,1 }, /* NO_OPEN */
	{ 5, -1, -1, G_TEXT, OF_NONE, OS_NORMAL, C_UNION(&rs_tedinfo[3]), 1,5, 56,1 }, /* NO_PRT_MEM */
	{ 0, -1, -1, G_TEXT, OF_LASTOB, OS_NORMAL, C_UNION(&rs_tedinfo[4]), 1,2054, 56,1 } /* NO_PREP_MEM */
};
...
#ifdef __STDC__
_WORD printw_rsc_load(_WORD wchar, _WORD hchar)
#else
_WORD printw_rsc_load(wchar, hchar)
_WORD wchar;
_WORD wchar;
#endif
{
...
#ifdef __STDC__
_WORD printw_rsc_gaddr(_WORD type, _WORD idx, void *gaddr)
#else
_WORD printw_rsc_gaddr(type, idx, gaddr)
_WORD type;
_WORD idx;
void *gaddr;
#endif
...
#ifdef __STDC__
_WORD printw_rsc_free(void)
#else
_WORD printw_rsc_free()
#endif
{
#if NUM_OBS != 0
