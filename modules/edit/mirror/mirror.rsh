/*
 * GEM resource C output of mirror
 *
...
static char mirror_string_0[] = "  spiegeln";
static char mirror_string_1[] = "horizontal";
static char mirror_string_2[] = "";
static char mirror_string_3[] = "";
static char mirror_string_4[] = "vertikal";
static char mirror_string_5[] = "";
static char mirror_string_6[] = "";
static char mirror_string_7[] = "beide";
static char mirror_string_8[] = "";
...
/* MIRROR_POP */
	...
	{ 2, -1, -1, G_STRING, OF_FL3DBAK, OS_DISABLED, C_UNION(mirror_string_0), 512,512, 10,1 },
	{ 3, -1, -1, G_BOXTEXT, 0x601, OS_DRAW3D, C_UNION(&rs_tedinfo[0]), 768,1281, 780,1 }, /* HORIZONT */
	{ 4, -1, -1, G_BOXTEXT, 0x601, OS_DRAW3D, C_UNION(&rs_tedinfo[1]), 768,2306, 780,1 }, /* VERTIKAL */
	{ 0, -1, -1, G_BOXTEXT, 0x621, OS_DRAW3D, C_UNION(&rs_tedinfo[2]), 768,3331, 780,257 } /* BOTH */
};
...
#ifdef __STDC__
_WORD mirror_rsc_load(_WORD wchar, _WORD hchar)
#else
_WORD mirror_rsc_load(wchar, hchar)
_WORD wchar;
_WORD wchar;
#endif
{
...
#ifdef __STDC__
_WORD mirror_rsc_gaddr(_WORD type, _WORD idx, void *gaddr)
#else
_WORD mirror_rsc_gaddr(type, idx, gaddr)
_WORD type;
_WORD idx;
void *gaddr;
#endif
...
#ifdef __STDC__
_WORD mirror_rsc_free(void)
#else
_WORD mirror_rsc_free()
#endif
{
#if NUM_OBS != 0
