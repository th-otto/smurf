...
static char tga_string_0[] = "OK";
static char tga_string_1[] = "RLE";
static char tga_string_2[] = "";
static char tga_string_3[] = "";
static char tga_string_4[] = "keine";
static char tga_string_5[] = "";
static char tga_string_6[] = "";
static char tga_string_7[] = " Kompression ";
static char tga_string_8[] = "";
static char tga_string_9[] = "";
static char tga_string_10[] = "sichern";
static char tga_string_11[] = "TGA Exporter";
...
TEDINFO rs_tedinfo[NUM_TI] = {
	{ tga_string_1, tga_string_2, tga_string_3, IBM, 6, TE_LEFT, 0x1100, 0x0, -1, 4,1 },
	{ tga_string_4, tga_string_5, tga_string_6, IBM, 6, TE_LEFT, 0x1100, 0x0, -1, 6,1 },
	{ tga_string_7, tga_string_8, tga_string_9, IBM, 6, TE_LEFT, 0x1180, 0x0, -1, 14,1 }
};
...
/* TGA_EXPORT */
	...
	{ 2, -1, -1, G_BUTTON, 0x607, OS_NORMAL, C_UNION(tga_string_0), 1044,8, 8,1 }, /* OK */
	...
	{ 3, -1, -1, (43<<8)+G_IBOX, 0x411, OS_NORMAL, C_UNION(0xFF1100L), 2,2050, 8,1 }, /* RLE */
	{ 9, -1, -1, G_TEXT, OF_FL3DBAK, OS_NORMAL, C_UNION(&rs_tedinfo[2]), 3,2049, 13,1 },
	{ 0, -1, -1, G_BUTTON, 0x625, OS_NORMAL, C_UNION(tga_string_10), 1034,8, 8,1 } /* SAVE */
};


OBJECT *rs_trindex[NUM_TREE] = {
	&rs_object[0] /* TGA_EXPORT */
};
...
#ifdef __STDC__
_WORD tga_rsc_load(_WORD wchar, _WORD hchar)
#else
_WORD tga_rsc_load(wchar, hchar)
_WORD wchar;
_WORD wchar;
#endif
{
...
#ifdef __STDC__
_WORD tga_rsc_gaddr(_WORD type, _WORD idx, void *gaddr)
#else
_WORD tga_rsc_gaddr(type, idx, gaddr)
_WORD type;
_WORD idx;
void *gaddr;
#endif
