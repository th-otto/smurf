...
static char sgi_string_0[] = "OK";
static char sgi_string_1[] = "RLE";
static char sgi_string_2[] = "";
static char sgi_string_3[] = "";
static char sgi_string_4[] = "none";
static char sgi_string_5[] = "";
static char sgi_string_6[] = "";
static char sgi_string_7[] = " Compression ";
static char sgi_string_8[] = "";
static char sgi_string_9[] = "";
static char sgi_string_10[] = "save";
static char sgi_string_11[] = "SGI Exporter";
static char sgi_string_12[] = "Not enough memory to correct orientation.";
...
static TEDINFO rs_tedinfo[NUM_TI] = {
	{ sgi_string_1, sgi_string_2, sgi_string_3, IBM, 6, TE_LEFT, 0x1100, 0x0, -1, 4,1 },
	{ sgi_string_4, sgi_string_5, sgi_string_6, IBM, 6, TE_LEFT, 0x1100, 0x0, -1, 5,1 },
	{ sgi_string_7, sgi_string_8, sgi_string_9, IBM, 6, TE_LEFT, 0x1180, 0x0, -1, 14,1 }
};
...
/* SGI_EXPORT */
	...
	{ 2, -1, -1, G_BUTTON, 0x607, OS_NORMAL, C_UNION(sgi_string_0), 1044,8, 8,1 }, /* OK */
	...
	{ 6, -1, -1, G_TEXT, OF_NONE, OS_NORMAL, C_UNION(&rs_tedinfo[1]), 4,1, 4,1 },
	...
	{ 0, -1, -1, G_BUTTON, 0x625, OS_NORMAL, C_UNION(sgi_string_10), 10,8, 8,1 } /* SAVE */
};


static OBJECT *rs_trindex[NUM_TREE] = {
	&rs_object[0] /* SGI_EXPORT */
};
...
#ifdef __STDC__
_WORD sgi_rsc_load(_WORD wchar, _WORD hchar)
#else
_WORD sgi_rsc_load(wchar, hchar)
_WORD wchar;
_WORD wchar;
#endif
{
...
#ifdef __STDC__
_WORD sgi_rsc_gaddr(_WORD type, _WORD idx, void *gaddr)
#else
_WORD sgi_rsc_gaddr(type, idx, gaddr)
_WORD type;
_WORD idx;
void *gaddr;
#endif
