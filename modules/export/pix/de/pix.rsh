...
static char pix_string_0[] = "sichern";
static char pix_string_1[] = "RLE";
static char pix_string_2[] = "";
static char pix_string_3[] = "";
static char pix_string_4[] = "keine";
static char pix_string_5[] = "";
static char pix_string_6[] = "";
static char pix_string_7[] = "-> PI?";
static char pix_string_8[] = "-> PC?";
static char pix_string_9[] = " Kompression ";
static char pix_string_10[] = "";
static char pix_string_11[] = "";
static char pix_string_12[] = "OK";
static char pix_string_13[] = "Degas Exporter";
...
static TEDINFO rs_tedinfo[NUM_TI] = {
	{ pix_string_1, pix_string_2, pix_string_3, IBM, 6, TE_LEFT, 0x1100, 0x0, -1, 4,1 },
	{ pix_string_4, pix_string_5, pix_string_6, IBM, 6, TE_LEFT, 0x1100, 0x0, -1, 6,1 },
	{ pix_string_9, pix_string_10, pix_string_11, IBM, 6, TE_LEFT, 0x1180, 0x0, -1, 14,1 }
};
...
/* PIX_EXPORT */
	...
	{ -1, 1, 11, G_BOX, OF_FL3DBAK, OS_NORMAL, C_UNION(0x1100L), 0,0, 31,10 },
	{ 2, -1, -1, G_BUTTON, 0x605, OS_NORMAL, C_UNION(pix_string_0), 1034,8, 8,1 }, /* SAVE */
	{ 3, -1, -1, G_IBOX, OF_FL3DBAK, OS_NORMAL, C_UNION(0x10100L), 258,258, 27,2052 },
	{ 10, 4, 9, G_IBOX, OF_FL3DBAK, OS_NORMAL, C_UNION(0x11100L), 2,2, 27,2052 },
	{ 5, -1, -1, G_TEXT, OF_NONE, OS_NORMAL, C_UNION(&rs_tedinfo[0]), 1028,2050, 3,1 },
	{ 6, -1, -1, G_TEXT, OF_NONE, OS_NORMAL, C_UNION(&rs_tedinfo[1]), 1028,1, 5,1 },
	{ 7, -1, -1, (43<<8)+G_IBOX, 0x411, OS_SELECTED, C_UNION(0xFF1100L), 2,1, 8,1 }, /* KEINE */
	{ 8, -1, -1, (43<<8)+G_IBOX, 0x411, OS_DISABLED, C_UNION(0xFF1100L), 2,2050, 8,1 }, /* RLE */
	{ 9, -1, -1, G_STRING, OF_NONE, OS_NORMAL, C_UNION(pix_string_7), 1035,1, 6,1 },
	{ 3, -1, -1, G_STRING, OF_NONE, OS_NORMAL, C_UNION(pix_string_8), 1035,2050, 6,1 },
	{ 11, -1, -1, G_TEXT, OF_FL3DBAK, OS_NORMAL, C_UNION(&rs_tedinfo[2]), 3,2049, 13,1 },
	{ 0, -1, -1, G_BUTTON, 0x627, OS_NORMAL, C_UNION(pix_string_12), 1044,8, 8,1 } /* OK */
};


static OBJECT *rs_trindex[NUM_TREE] = {
	&rs_object[0] /* PIX_EXPORT */
};
...
#ifdef __STDC__
_WORD pix_rsc_load(_WORD wchar, _WORD hchar)
#else
_WORD pix_rsc_load(wchar, hchar)
_WORD wchar;
_WORD wchar;
#endif
{
...
#ifdef __STDC__
_WORD pix_rsc_gaddr(_WORD type, _WORD idx, void *gaddr)
#else
_WORD pix_rsc_gaddr(type, idx, gaddr)
_WORD type;
_WORD idx;
void *gaddr;
#endif
