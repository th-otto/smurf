...
static char ppm_string_0[] = "OK";
static char ppm_string_1[] = "ASCII";
static char ppm_string_2[] = "";
static char ppm_string_3[] = "";
static char ppm_string_4[] = "bin\204r";
static char ppm_string_5[] = "";
static char ppm_string_6[] = "";
static char ppm_string_7[] = " Organisation ";
static char ppm_string_8[] = "";
static char ppm_string_9[] = "";
static char ppm_string_10[] = "sichern";
static char ppm_string_11[] = "PBMPlus Exporter";
...
TEDINFO rs_tedinfo[NUM_TI] = {
	{ ppm_string_1, ppm_string_2, ppm_string_3, IBM, 6, TE_LEFT, 0x1100, 0x0, -1, 6,1 },
	{ ppm_string_4, ppm_string_5, ppm_string_6, IBM, 6, TE_LEFT, 0x1100, 0x0, -1, 6,1 },
	{ ppm_string_7, ppm_string_8, ppm_string_9, IBM, 6, TE_LEFT, 0x1180, 0x0, -1, 15,1 }
};
...
/* PPM_EXPORT */
	...
	{ 2, -1, -1, G_BUTTON, 0x607, OS_NORMAL, C_UNION(ppm_string_0), 1044,8, 8,1 }, /* OK */
	...
	{ 5, -1, -1, G_TEXT, OF_NONE, OS_NORMAL, C_UNION(&rs_tedinfo[0]), 1028,2050, 5,1 },
	{ 6, -1, -1, G_TEXT, OF_NONE, OS_NORMAL, C_UNION(&rs_tedinfo[1]), 1028,1, 5,1 },
	{ 7, -1, -1, (43<<8)+G_IBOX, 0x411, OS_SELECTED, C_UNION(0xFF1100L), 2,1, 8,1 }, /* BIN */
	{ 3, -1, -1, (43<<8)+G_IBOX, 0x411, OS_NORMAL, C_UNION(0xFF1100L), 2,2050, 8,1 }, /* ASCII */
	{ 9, -1, -1, G_TEXT, OF_FL3DBAK, OS_NORMAL, C_UNION(&rs_tedinfo[2]), 3,2049, 14,1 },
	{ 0, -1, -1, G_BUTTON, 0x625, OS_NORMAL, C_UNION(ppm_string_10), 1034,8, 8,1 } /* SAVE */
};


OBJECT *rs_trindex[NUM_TREE] = {
	&rs_object[0] /* PPM_EXPORT */
};
...
#ifdef __STDC__
_WORD ppm_rsc_load(_WORD wchar, _WORD hchar)
#else
_WORD ppm_rsc_load(wchar, hchar)
_WORD wchar;
_WORD wchar;
#endif
{
...
#ifdef __STDC__
_WORD ppm_rsc_gaddr(_WORD type, _WORD idx, void *gaddr)
#else
_WORD ppm_rsc_gaddr(type, idx, gaddr)
_WORD type;
_WORD idx;
void *gaddr;
#endif
