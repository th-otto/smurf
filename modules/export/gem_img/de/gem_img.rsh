/*
 * GEM resource C output of gem_img
 *
...
static char gem_img_string_0[] = "OK";
static char gem_img_string_1[] = "Pixart";
static char gem_img_string_2[] = "";
static char gem_img_string_3[] = "";
static char gem_img_string_4[] = "GEM-View";
static char gem_img_string_5[] = "";
static char gem_img_string_6[] = "";
static char gem_img_string_7[] = " TC-Organisation ";
static char gem_img_string_8[] = "";
static char gem_img_string_9[] = "";
static char gem_img_string_10[] = "erweitertes Format";
static char gem_img_string_11[] = "";
static char gem_img_string_12[] = "";
static char gem_img_string_13[] = "sichern";


TEDINFO rs_tedinfo[NUM_TI] = {
	{ gem_img_string_1, gem_img_string_2, gem_img_string_3, IBM, 6, TE_LEFT, 0x1100, 0x0, -1, 7,1 },
	{ gem_img_string_4, gem_img_string_5, gem_img_string_6, IBM, 6, TE_LEFT, 0x1100, 0x0, -1, 9,1 },
	{ gem_img_string_7, gem_img_string_8, gem_img_string_9, IBM, 6, TE_LEFT, 0x1180, 0x0, -1, 18,1 },
	{ gem_img_string_10, gem_img_string_11, gem_img_string_12, IBM, 6, TE_LEFT, 0x1100, 0x0, -1, 19,1 }
};
...
/* XIMG_EXPORT */
	...
	{ -1, 1, 11, G_BOX, OF_FL3DBAK, OS_NORMAL, C_UNION(0x1100L), 0,0, 31,2059 },
	{ 2, -1, -1, G_BUTTON, 0x607, OS_NORMAL, C_UNION(gem_img_string_0), 1044,2057, 8,1 }, /* OK */
	{ 3, -1, -1, G_IBOX, OF_FL3DBAK, OS_NORMAL, C_UNION(0x10100L), 258,2307, 27,2052 },
	{ 8, 4, 7, G_IBOX, OF_FL3DBAK, OS_NORMAL, C_UNION(0x11100L), 2,2051, 27,2052 },
	{ 5, -1, -1, G_TEXT, OF_NONE, OS_NORMAL, C_UNION(&rs_tedinfo[0]), 1028,2050, 6,1 },
	{ 6, -1, -1, G_TEXT, OF_NONE, OS_NORMAL, C_UNION(&rs_tedinfo[1]), 1028,1, 8,1 },
	{ 7, -1, -1, (43<<8)+G_IBOX, 0x411, OS_SELECTED, C_UNION(0xFF1100L), 2,1, 11,1 }, /* GVW */
	{ 3, -1, -1, (43<<8)+G_IBOX, 0x411, OS_DISABLED, C_UNION(0xFF1100L), 2,2050, 9,1 }, /* PIXA */
	{ 9, -1, -1, G_TEXT, OF_FL3DBAK, OS_NORMAL, C_UNION(&rs_tedinfo[2]), 3,3, 17,1 },
	{ 10, -1, -1, G_TEXT, OF_NONE, OS_NORMAL, C_UNION(&rs_tedinfo[3]), 1028,1, 18,1 },
	{ 11, -1, -1, (44<<8)+G_IBOX, 0x401, OS_SELECTED, C_UNION(0xFF1100L), 2,1, 21,1 }, /* FORMAT */
	{ 0, -1, -1, G_BUTTON, 0x625, OS_NORMAL, C_UNION(gem_img_string_13), 1034,2057, 8,1 } /* SAVE */
};


OBJECT *rs_trindex[NUM_TREE] = {
	&rs_object[0] /* XIMG_EXPORT */
};
...
#ifdef __STDC__
_WORD gem_img_rsc_load(_WORD wchar, _WORD hchar)
#else
_WORD gem_img_rsc_load(wchar, hchar)
_WORD wchar;
_WORD wchar;
#endif
{
...
#ifdef __STDC__
_WORD gem_img_rsc_gaddr(_WORD type, _WORD idx, void *gaddr)
#else
_WORD gem_img_rsc_gaddr(type, idx, gaddr)
_WORD type;
_WORD idx;
void *gaddr;
#endif
...
#ifdef __STDC__
_WORD gem_img_rsc_free(void)
#else
_WORD gem_img_rsc_free()
#endif
{
#if NUM_OBS != 0
